...
const reduceTime = document.querySelector('#minus')
const increaseTime = document.querySelector('#plus')
const likes = document.querySelector('.likes')

timer.textContent = 0

const countUpTime = setInterval(() => {
    timer.textContent ++
},1000)

reduceTime.addEventListener('click', reduce)
increaseTime.addEventListener('click', increase)
